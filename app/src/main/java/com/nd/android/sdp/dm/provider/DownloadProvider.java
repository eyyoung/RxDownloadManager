...
public class DownloadProvider extends BaseContentProvider {
    ...
    public static final String AUTHORITY = "com.nd.android.sdp.dm.provider";
    ...
    protected SQLiteOpenHelper createSqLiteOpenHelper() {
        return DownloadSQLiteOpenHelper.getInstance(getContext());
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case URI_TYPE_DOWNLOADS:
                return TYPE_CURSOR_DIR + DownloadsColumns.TABLE_NAME;
            case URI_TYPE_DOWNLOADS_ID:
                return TYPE_CURSOR_ITEM + DownloadsColumns.TABLE_NAME;
    ...
    protected QueryParams getQueryParams(Uri uri, String selection, String[] projection) {
        ...
        switch (matchedId) {
            case URI_TYPE_DOWNLOADS:
            case URI_TYPE_DOWNLOADS_ID:
                res.table = DownloadsColumns.TABLE_NAME;
                res.idColumn = DownloadsColumns._ID;
                res.tablesWithJoins = DownloadsColumns.TABLE_NAME;
                res.orderBy = DownloadsColumns.DEFAULT_ORDER;
                break;
